...
data CodeRegister = CodeEax
                  ...
                  | CodeEsi
                  | CodeEdi
                  | Invalid_X86_Register
  
reg :: Int -> CodeRegister
reg r = case r of
        0 -> CodeEax
        1 -> CodeEcx
        2 -> CodeEbx
        ...
        6 -> CodeEbp
        7 -> CodeEsp
        _ -> Invalid_X86_Register


data DwarfRegister = DwarfEax
                   | DwarfEcx
                   | DwarfEdx
                   | DwarfEbx
                   | DwarfEsp
                   ...
                   | DwarfEsi
                   | DwarfEdi
                   | Invalid_Dwarf_Register

dwarf_reg :: Int -> DwarfRegister
dwarf_reg r = case r of
      0 -> DwarfEax
      1 -> DwarfEcx
      2 -> DwarfEbx
      3 -> DwarfEsi
